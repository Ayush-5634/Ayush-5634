...
#         self.UI()
#     def UI(self):
#         row_label = QLabel("Number of rows : ",self)  
#         row_label.move(0,0)
...
class MainApp(QMainWindow):
    ...
    def create_menu_bar(self):
        ...
        clear_action.setShortcut('CTRL+H')
        edit_menu.addAction(clear_action)

        # select all
        select_action = QAction('Select All', self)
        select_action.triggered.connect(self.editor.selectAll)
        select_action.setShortcut('CTRL+Q')
    ...
    def create_toolbar(self):
        ...
        # undo
        undo_action = QAction( 'Undo', self) # QIcon("MyWord-main/undo.png"),
        undo_action.triggered.connect(self.editor.undo)
        ToolBar.addAction(undo_action)

        # redo
        redo_action = QAction( 'Redo', self) #QIcon("MyWord-main/redo.png"),
        ...
        # text alignment
        right_alignment_action = QAction( 'Align Right', self) # QIcon("right-align.png"),
        ...
        left_alignment_action = QAction( 'Align Left', self) # QIcon("left-align.png"),
        ...
        justification_action = QAction( 'Center/Justify', self) # QIcon("justification.png"),
        ...
        # add_table = QAction(QIcon(""),"add table",self)
        # add_table.triggered.connect(self.table)
        # ToolBar.addAction(add_table)
